...
public class MainApplication {
    ...
    public static void main(String[] args) {
        ...
        switch (option) {
            case '1':
              ...
              //1  char shopOption = scanner.nextInt().charAt(0);
    ...
    private static void displayShops(Shop shop){
        System.out.println("Product ID : " + shop.getProductId());
        System.out.println("Product Name : " + shop.getShopName());
        System.out.println("Shop Address :" +shop.getShopAddress() );
    }
